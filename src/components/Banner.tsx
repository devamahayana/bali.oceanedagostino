  ...
  return (
    <section className='bg-secondary h-auto py-20 w-full text-center flex flex-col lg:gap-0 gap-4 items-center justify-center relative overflow-hidden'>
        ...
        <div className='w-fit flex flex-col text-center items-center justify-center px-8 mt-6'>
            ...
            <h1 className='lg:text-5xl sm:text-4xl text-3xl font-semibold italic text-primary relative text-center w-fit will-change-transform'>+ de 20% de rentabilité brut annuelle !
        ...
        <div className='flex gap-2 z-50'>
            ...
            <Links
                ...
                icon=""
                variant="btn-primary-border"
                href="https://wa.me/33756967333?text=Bonjour,%20je%20viens%20de%20https://go.balimmo.fr/.%20Pouvez-vous%20m%27en%20dire%20plus%20svp%20?"
            />
        </div>
